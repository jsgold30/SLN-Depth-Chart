...
DRAFT_PLAYER_POOL = [
    ...
    {'id':'','name':'Wesley Day',            'pos':'PG','ht':"6'2\"" ,'wt':'175','age':'22','in_rat':'D+','out_rat':'C+','hn':'C' ,'df':'C' ,'reb':'D+','pot':'C'},
    {'id':'','name':'Daxton Cardinal',       'pos':'PG','ht':"6'3\"" ,'wt':'190','age':'22','in_rat':'C' ,'out_rat':'C' ,'hn':'C+','df':'C+','reb':'D+','pot':'C'},
    {'id':'','name':'Ulusoy Uzan',           'pos':'PG','ht':"6'3\"" ,'wt':'185','age':'23','in_rat':'C' ,'out_rat':'C+','hn':'C' ,'df':'B' ,'reb':'D+','pot':'C'},
    {'id':'','name':'Louvell Griffin',       'pos':'PG','ht':"6'3\"" ,'wt':'180','age':'22','in_rat':'C' ,'out_rat':'C+','hn':'C' ,'df':'C' ,'reb':'C-','pot':'C'},
    {'id':'','name':"Ra'aed James",          'pos':'PG','ht':"6'2\"" ,'wt':'195','age':'23','in_rat':'C' ,'out_rat':'C' ,'hn':'C+','df':'C' ,'reb':'C-','pot':'C'},
    {'id':'','name':'Rain Waters',           'pos':'PG','ht':"6'0\"" ,'wt':'180','age':'23','in_rat':'D+','out_rat':'B-','hn':'B' ,'df':'B-','reb':'D-','pot':'C'},
    {'id':'','name':'Deng Dong',             'pos':'PG','ht':"6'2\"" ,'wt':'190','age':'23','in_rat':'C' ,'out_rat':'B-','hn':'B+','df':'C' ,'reb':'C-','pot':'C'},
    {'id':'','name':'Cardarion Phillips',    'pos':'PG','ht':"6'3\"" ,'wt':'190','age':'22','in_rat':'C' ,'out_rat':'C' ,'hn':'C+','df':'C' ,'reb':'C-','pot':'C'},
    {'id':'','name':'Unyque Wiley',          'pos':'PG','ht':"6'3\"" ,'wt':'200','age':'22','in_rat':'C' ,'out_rat':'B-','hn':'C' ,'df':'B+','reb':'D+','pot':'C'},
    {'id':'','name':'Acqwon Gibbs',          'pos':'PG','ht':"6'3\"" ,'wt':'200','age':'22','in_rat':'C-','out_rat':'C+','hn':'B+','df':'C' ,'reb':'C-','pot':'C'},
    {'id':'','name':'Jaymore Hopkins',       'pos':'PG','ht':"6'3\"" ,'wt':'195','age':'22','in_rat':'B' ,'out_rat':'B+','hn':'C' ,'df':'D+','reb':'D+','pot':'C'},
    {'id':'','name':'Efrem Barrett',         'pos':'PG','ht':"6'4\"" ,'wt':'190','age':'22','in_rat':'C+','out_rat':'B-','hn':'B-','df':'C+','reb':'C-','pot':'C'},
    {'id':'','name':'Zaniel Burnett',        'pos':'PG','ht':"6'1\"" ,'wt':'180','age':'22','in_rat':'C' ,'out_rat':'B+','hn':'C' ,'df':'C' ,'reb':'C-','pot':'C'},
    {'id':'','name':'Ben Moore',             'pos':'SG','ht':"6'3\"" ,'wt':'195','age':'22','in_rat':'C' ,'out_rat':'C' ,'hn':'C' ,'df':'C' ,'reb':'C-','pot':'C'},
    {'id':'','name':'Jack Brooks',           'pos':'SG','ht':"6'6\"" ,'wt':'205','age':'22','in_rat':'C' ,'out_rat':'C+','hn':'C-','df':'C' ,'reb':'C-','pot':'C'},
    {'id':'','name':'Shane Berger',          'pos':'SG','ht':"6'5\"" ,'wt':'180','age':'23','in_rat':'C' ,'out_rat':'C' ,'hn':'C' ,'df':'C+','reb':'C-','pot':'C'},
    {'id':'','name':'Andres Wheeler',        'pos':'SG','ht':"6'4\"" ,'wt':'210','age':'23','in_rat':'C' ,'out_rat':'B' ,'hn':'C' ,'df':'C' ,'reb':'C-','pot':'C'},
    {'id':'','name':'Rodney Orr',            'pos':'SG','ht':"6'6\"" ,'wt':'215','age':'23','in_rat':'C' ,'out_rat':'C+','hn':'C' ,'df':'C' ,'reb':'C-','pot':'C'},
    {'id':'','name':'Jeremiah Norton',       'pos':'SG','ht':"6'5\"" ,'wt':'195','age':'23','in_rat':'C' ,'out_rat':'B+','hn':'C-','df':'C+','reb':'C-','pot':'C'},
    {'id':'','name':'Archer Haney',          'pos':'SG','ht':"6'6\"" ,'wt':'200','age':'22','in_rat':'C+','out_rat':'C+','hn':'C-','df':'C' ,'reb':'C' ,'pot':'C'},
    {'id':'','name':'Isaac Henderson',       'pos':'SG','ht':"6'4\"" ,'wt':'200','age':'23','in_rat':'C' ,'out_rat':'B' ,'hn':'C-','df':'B' ,'reb':'C-','pot':'C'},
    {'id':'','name':'Ernest Talley',         'pos':'SG','ht':"6'7\"" ,'wt':'190','age':'22','in_rat':'C+','out_rat':'C+','hn':'C+','df':'C+','reb':'C' ,'pot':'C'},
    {'id':'','name':'Karter Glenn',          'pos':'SG','ht':"6'5\"" ,'wt':'195','age':'22','in_rat':'B-','out_rat':'C+','hn':'C' ,'df':'C+','reb':'C-','pot':'C'},
    {'id':'','name':'Corey Shields',         'pos':'SG','ht':"6'6\"" ,'wt':'185','age':'22','in_rat':'C+','out_rat':'C' ,'hn':'C' ,'df':'B+','reb':'C-','pot':'C'},
    {'id':'','name':'Aristeidis Economallis','pos':'SG','ht':"6'7\"" ,'wt':'205','age':'22','in_rat':'B-','out_rat':'B' ,'hn':'C' ,'df':'C' ,'reb':'C+','pot':'C'},
    {'id':'','name':'Zdenko Oreski',         'pos':'SG','ht':"6'5\"" ,'wt':'195','age':'21','in_rat':'C+','out_rat':'B+','hn':'C+','df':'C+','reb':'C-','pot':'C'},
    {'id':'','name':'Clayton Pierce',        'pos':'SF','ht':"6'6\"" ,'wt':'215','age':'22','in_rat':'C' ,'out_rat':'C' ,'hn':'C-','df':'C' ,'reb':'C-','pot':'C'},
    {'id':'','name':'Donjae Banks',          'pos':'SF','ht':"6'9\"" ,'wt':'225','age':'23','in_rat':'C+','out_rat':'C' ,'hn':'C' ,'df':'C+','reb':'C' ,'pot':'C'},
    {'id':'','name':'Raden Dixon',           'pos':'SF','ht':"6'7\"" ,'wt':'215','age':'22','in_rat':'C' ,'out_rat':'C' ,'hn':'C-','df':'C' ,'reb':'C' ,'pot':'C'},
    {'id':'','name':'Kelford Lindsey',       'pos':'SF','ht':"6'5\"" ,'wt':'220','age':'23','in_rat':'C' ,'out_rat':'C' ,'hn':'C+','df':'C' ,'reb':'C' ,'pot':'C'},
    {'id':'','name':'Brackston Ford',        'pos':'SF','ht':"6'7\"" ,'wt':'210','age':'22','in_rat':'C' ,'out_rat':'B-','hn':'C-','df':'B-','reb':'C' ,'pot':'C'},
    {'id':'','name':'Dwane McBride',         'pos':'SF','ht':"6'8\"" ,'wt':'230','age':'22','in_rat':'B-','out_rat':'C' ,'hn':'C-','df':'C' ,'reb':'C' ,'pot':'C'},
    {'id':'','name':'Reshard Thornton',      'pos':'SF','ht':"6'8\"" ,'wt':'225','age':'23','in_rat':'C' ,'out_rat':'C' ,'hn':'C' ,'df':'B-','reb':'C' ,'pot':'C'},
    {'id':'','name':'Slavoljub Ignjatovic',  'pos':'SF','ht':"6'9\"" ,'wt':'215','age':'23','in_rat':'C' ,'out_rat':'C+','hn':'C+','df':'C+','reb':'C-','pot':'C'},
    {'id':'','name':'Yannick Fellerer',      'pos':'SF','ht':"6'8\"" ,'wt':'210','age':'21','in_rat':'C' ,'out_rat':'C' ,'hn':'C' ,'df':'C' ,'reb':'C+','pot':'C'},
    {'id':'','name':'Keon McKinney',         'pos':'SF','ht':"6'7\"" ,'wt':'220','age':'22','in_rat':'C' ,'out_rat':'B-','hn':'C' ,'df':'C' ,'reb':'C' ,'pot':'C'},
    {'id':'','name':'Xiang Gang',            'pos':'SF','ht':"6'7\"" ,'wt':'205','age':'22','in_rat':'C+','out_rat':'C+','hn':'C+','df':'C+','reb':'C' ,'pot':'C'},
    {'id':'','name':'Arris Caldwell',        'pos':'SF','ht':"6'9\"" ,'wt':'215','age':'22','in_rat':'C' ,'out_rat':'B' ,'hn':'C' ,'df':'C+','reb':'C' ,'pot':'C'},
    {'id':'','name':'Darryon Lee',           'pos':'SF','ht':"6'8\"" ,'wt':'210','age':'23','in_rat':'C' ,'out_rat':'C+','hn':'C-','df':'B+','reb':'C+','pot':'C'},
    {'id':'','name':'Sakeem Hudson',         'pos':'SF','ht':"6'8\"" ,'wt':'220','age':'22','in_rat':'C+','out_rat':'B-','hn':'C' ,'df':'B-','reb':'C' ,'pot':'C'},
    {'id':'','name':'Jasen Singleton',       'pos':'SF','ht':"6'7\"" ,'wt':'225','age':'22','in_rat':'C' ,'out_rat':'C' ,'hn':'C' ,'df':'B' ,'reb':'B' ,'pot':'C'},
    {'id':'','name':'Shovon Rhodes',         'pos':'SF','ht':"6'9\"" ,'wt':'220','age':'21','in_rat':'A' ,'out_rat':'C' ,'hn':'D+','df':'C' ,'reb':'C' ,'pot':'C'},
    {'id':'','name':'Deveron Simmons',       'pos':'PF','ht':"6'9\"" ,'wt':'235','age':'22','in_rat':'C' ,'out_rat':'C-','hn':'D+','df':'C+','reb':'C' ,'pot':'C'},
    {'id':'','name':'Kordell Pierce',        'pos':'PF','ht':"6'11\"",'wt':'235','age':'23','in_rat':'C' ,'out_rat':'C-','hn':'D+','df':'C' ,'reb':'C' ,'pot':'C'},
    {'id':'','name':'Jacody Knight',         'pos':'PF','ht':"6'11\"",'wt':'240','age':'22','in_rat':'C+','out_rat':'C-','hn':'D+','df':'C+','reb':'C+','pot':'C'},
    {'id':'','name':'Stefon Roberson',       'pos':'PF','ht':"6'8\"" ,'wt':'225','age':'23','in_rat':'C' ,'out_rat':'C+','hn':'D+','df':'C' ,'reb':'C' ,'pot':'C'},
    {'id':'','name':'LeeShawn Dixon',        'pos':'PF','ht':"6'10\"",'wt':'245','age':'22','in_rat':'C+','out_rat':'C+','hn':'C-','df':'C' ,'reb':'C' ,'pot':'C'},
    {'id':'','name':'Zharvis O\'Neal',       'pos':'PF','ht':"6'9\"" ,'wt':'240','age':'23','in_rat':'C+','out_rat':'C-','hn':'D+','df':'C' ,'reb':'C' ,'pot':'C'},
    {'id':'','name':'Oday Graves',           'pos':'PF','ht':"6'9\"" ,'wt':'230','age':'22','in_rat':'C+','out_rat':'C+','hn':'C-','df':'C+','reb':'C+','pot':'C'},
    {'id':'','name':'Travone Saunders',      'pos':'PF','ht':"6'11\"",'wt':'240','age':'23','in_rat':'B-','out_rat':'C' ,'hn':'C-','df':'C' ,'reb':'C' ,'pot':'C'},
    {'id':'','name':'Carmelo Johnston',      'pos':'PF','ht':"6'10\"",'wt':'225','age':'22','in_rat':'C+','out_rat':'C-','hn':'C-','df':'C+','reb':'B-','pot':'C'},
    {'id':'','name':'Makai Williams',        'pos':'PF','ht':"6'10\"",'wt':'230','age':'23','in_rat':'B' ,'out_rat':'B' ,'hn':'D' ,'df':'C' ,'reb':'C' ,'pot':'C'},
    {'id':'','name':'Draven Fletcher',       'pos':'PF','ht':"7'1\"" ,'wt':'230','age':'22','in_rat':'C+','out_rat':'C+','hn':'C+','df':'B' ,'reb':'C+','pot':'C'},
    {'id':'','name':'Franklin Collier',      'pos':'PF','ht':"6'9\"" ,'wt':'250','age':'23','in_rat':'B-','out_rat':'C' ,'hn':'C-','df':'B-','reb':'C+','pot':'C'},
    {'id':'','name':'Mason Evans',           'pos':'PF','ht':"6'10\"",'wt':'240','age':'21','in_rat':'C' ,'out_rat':'B+','hn':'D' ,'df':'B+','reb':'B+','pot':'C'},
    {'id':'','name':'Bradley Hall',          'pos':'PF','ht':"6'9\"" ,'wt':'220','age':'22','in_rat':'B' ,'out_rat':'B-','hn':'D' ,'df':'B-','reb':'B-','pot':'C'},
    {'id':'','name':'Eric Campos',           'pos':'C' ,'ht':"6'10\"",'wt':'260','age':'23','in_rat':'C' ,'out_rat':'C-','hn':'C-','df':'C+','reb':'C' ,'pot':'C'},
    {'id':'','name':'Luke Shaw',             'pos':'C' ,'ht':"7'1\"" ,'wt':'250','age':'23','in_rat':'C+','out_rat':'D+','hn':'C-','df':'C' ,'reb':'C' ,'pot':'C'},
    {'id':'','name':'Andrew Chambers',       'pos':'C' ,'ht':"6'11\"",'wt':'240','age':'22','in_rat':'C' ,'out_rat':'D+','hn':'D' ,'df':'B-','reb':'C' ,'pot':'C'},
    {'id':'','name':'Samuel Gallagher',      'pos':'C' ,'ht':"6'11\"",'wt':'240','age':'22','in_rat':'C' ,'out_rat':'C-','hn':'C-','df':'C' ,'reb':'C+','pot':'C'},
    {'id':'','name':'Blaise Shannon',        'pos':'C' ,'ht':"6'10\"",'wt':'230','age':'23','in_rat':'C' ,'out_rat':'B-','hn':'C-','df':'C' ,'reb':'C+','pot':'C'},
    {'id':'','name':'Alexander Porter',      'pos':'C' ,'ht':"6'10\"",'wt':'230','age':'23','in_rat':'C+','out_rat':'D' ,'hn':'D' ,'df':'C+','reb':'C+','pot':'C'},
    {'id':'','name':'Lamar Murray',          'pos':'C' ,'ht':"6'10\"",'wt':'245','age':'22','in_rat':'C' ,'out_rat':'C-','hn':'D' ,'df':'C+','reb':'B-','pot':'C'},
    {'id':'','name':'Aaden Massey',          'pos':'C' ,'ht':"6'10\"",'wt':'225','age':'23','in_rat':'B' ,'out_rat':'C-','hn':'C-','df':'C' ,'reb':'C' ,'pot':'C'},
    {'id':'','name':'LeMaun Dorsey',         'pos':'C' ,'ht':"7'0\"" ,'wt':'250','age':'23','in_rat':'C+','out_rat':'C+','hn':'D-','df':'C+','reb':'C' ,'pot':'C'},
    {'id':'','name':'Bronte Wells',          'pos':'C' ,'ht':"6'11\"",'wt':'250','age':'22','in_rat':'C' ,'out_rat':'C+','hn':'D+','df':'B' ,'reb':'C' ,'pot':'C'},
    {'id':'','name':'Destin McDaniel',       'pos':'C' ,'ht':"6'10\"",'wt':'240','age':'22','in_rat':'B-','out_rat':'C' ,'hn':'C-','df':'B-','reb':'B-','pot':'C'},
    {'id':'','name':'Tamonte Dillard',       'pos':'C' ,'ht':"6'11\"",'wt':'235','age':'23','in_rat':'C+','out_rat':'B+','hn':'C-','df':'C' ,'reb':'C+','pot':'C'},
    {'id':'','name':'Kevante Polk',          'pos':'C' ,'ht':"7'1\"" ,'wt':'260','age':'22','in_rat':'B-','out_rat':'D+','hn':'D-','df':'B+','reb':'C+','pot':'C'},
    {'id':'','name':'TreKell Benjamin',      'pos':'C' ,'ht':"6'10\"",'wt':'255','age':'22','in_rat':'C+','out_rat':'C-','hn':'D-','df':'B' ,'reb':'B-','pot':'C'},
    {'id':'','name':'Parelle Logan',         'pos':'C' ,'ht':"6'11\"",'wt':'245','age':'22','in_rat':'B+','out_rat':'C+','hn':'D+','df':'C+','reb':'C+','pot':'C'},
]
